<template>
  <div class="changepsw">
    ...
    <div class="formBox">
      ...
      <div class="subbox">
        <input type="submit" class="submit" value="确认修改" ref="submit1" @click="changePassword" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    // 提交按钮启用检测
    btndisabled() {
      this.oldPassFormat && this.pswFormat && this.checkPswFormat
        ? (this.$refs.submit1.disabled = false)
        : (this.$refs.submit1.disabled = true)
    },
    //  修改密码
    changePassword() {
